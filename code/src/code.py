...
async def process_email(request: EmailRequest):
    ...
    request_type, sub_request_type, confidence = classify_email(extracted_text, request.request_definitions)
    
    # Extract relevant fields
    extracted_data = extract_fields(extracted_text, request.extraction_rules)
...
def classify_email(text: str, request_definitions: Dict[str, List[str]]) -> Tuple[str, str, float]:
...
def extract_fields(text: str, extraction_rules: Dict[str, str]) -> Dict[str, str]:
